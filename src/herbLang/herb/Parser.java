...
class Parser {
	...
	private Stmt forStatement() {
		...
		consume(RIGHT_PAREN, "Expect ')' after statement for clauses.");
		Stmt body = statement();
	...
	private Stmt ifStatement() {
		consume(LEFT_PAREN, "Expected '(' after statement 'if'.");
		Expr condition = expression();
		consume(RIGHT_PAREN, "Expected ')' after statement 'if' condition.");
	...
	private Stmt whileStatement() {
        consume(LEFT_PAREN, "Expected '(' after statement 'while'.");
        Expr condition = expression();
        consume(RIGHT_PAREN, "Expect ')' after statement 'while' condition.");
        Stmt body = statement();
